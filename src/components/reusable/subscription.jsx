...
export const Subscription = ({ plan, index }) => {
  return (
    <div
      className={`text-gray-600 border relative border-navy-800 border-opacity-85 rounded-2xl flex flex-col justify-between animate-fade-in-up`}
      style={{ animationDelay: `${0.1 + index * 0.1}s` }}
    >
      {plan?.isActive && (
        <div className='absolute py-1 top-[-0.8rem] right-1/3 w-40 bg-gradient-to-br from-navy-800 to-gray-300 rounded-lg flex justify-center items-center shadow'>
      ...
      >
        ...
        <button
          className={`mt-6 py-2 rounded-xl font-semibold transition-all duration-150 ${
            plan.isActive
