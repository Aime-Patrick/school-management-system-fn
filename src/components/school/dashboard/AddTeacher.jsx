...
const AddTeacher = ({visible, onClose}) => {
  const {createTeacher, createTeacherLoading, createTeacherSuccess} = useTeacher()
  ...
  return (
    <div className="card flex justify-content-center">
      ...
      >
        ...
        <div className="py-2 ">
         <select name="status" id="status" onChange={addTeacherFormik.handleChange} onBlur={addTeacherFormik.handleBlur} value={addTeacherFormik.values.status} className="w-full border border-gray-500 p-2 rounded-md placeholder:text-sm focus:outline-none focus:ring-1 focus:ring-gray-100">
        ...
        <div className="py-2 ">
         <select name="gender" id="gender" onChange={addTeacherFormik.handleChange} onBlur={addTeacherFormik.handleBlur} value={addTeacherFormik.values.gender} className="w-full border border-gray-500 p-2 rounded-md placeholder:text-sm focus:outline-none focus:ring-1 focus:ring-gray-100">
